...
public static class OmniSessionCompatibility
{
    ...
    {
        if (OmniLlamaProfile.ForBundle(runtime.BundleId) is null) return false;
...
public sealed class ImageAnalysisModelChangedException()
    : InvalidOperationException("This work belongs to another model. Start a new analysis to use the current model.")
{
}
