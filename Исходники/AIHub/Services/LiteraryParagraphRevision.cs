...
public static class LiteraryParagraphRevision
{
    public static string Capture(LiteraryEditorSnapshot editor)
    {
        ...
        var paths=new List<string> { "project.json", "chapters/index.json", "Plot/Writer.json", "Plot/Advisor.json", "Jelly/память.lopata" };
        ...
        return LiteraryWorkIndex.Revision(ParagraphJson.Encode(paths.Distinct().Order().Select(rel=>
        {
