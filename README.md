...
>
> Доступен публичный тестовый выпуск **0.2.5-beta**. Стабильного релиза пока нет. Ветка `main` содержит рабочую development-версию, экспериментальные сценарии и компоненты с известными ограничениями.

---

## Скачать и начать

**[Установщик 0.2.5-beta для Windows 11 x64](https://github.com/PiTrolKun/LOPATA/releases/tag/v0.2.5-beta)** · [Руководство пользователя](Документы_проекта/РУКОВОДСТВО.md) · [Изменения выпуска](Документы_проекта/Релизы/0.2.5-beta.md)
...
В публичной **0.2.5-beta** доступен и принят пользователем **быстрый импорт литературного проекта из DeepSeek**: локальная обработка ZIP/JSON, книга DOCX, новый проект и XLSX с историей. Подробности и ограничения — в [руководстве](Документы_проекта/РУКОВОДСТВО.md).
